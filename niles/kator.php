...
<div class="row">
	<div class="span4">
	<h1>
	<a class="logo" href="index.html"><span>KATOR SUPERMARKET</span> 
	...
	<h1 class="dotmark">
	<i class="icon-cut"></i>
		KATOR SPECIAL OFFERS
	</h1>
	</div>
	</div>
	<div class="span4 alignR">
		<p><br> <strong> IMMEDIATE CONTACT:  0800 1234 678 </strong><br><br></p>
	</div>
</div>
</header>
		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav nav-pills">
			  ...
			  <li class=""><a href="list-view.html">ABOUT KATOR</a></li>
			  <li class=""><a href="grid-view.html">COSMETICS</a></li>
			  <li class=""><a href="three-col.html">DRINKS</a></li>
			  <li class=""><a href="four-col.html">CARDS</a></li>
			  <li class=""><a href="general.html">JEWELRY</a></li>
			</ul>
			<form action="#" class="navbar-search pull-left search-form">
