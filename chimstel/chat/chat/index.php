...
<input name="sender" type="text" id="texta" value="<?php echo $sender ?>" placeholder="Enter your name for identification on the chat"/>
<div class="refresh">
<?php
$con = mysql_connect("localhost","root","");
if (!$con)
...
$result = mysql_query("SELECT DISTINCT * FROM message ORDER BY id DESC");


while($row = mysql_fetch_array($result))
  {
  echo '<p>'.'<span>'.$row['sender'].'</span>'.'</p>'.'<p>'. '&nbsp;&nbsp;' . $row['message'].'</p>';
  }
